  ...
  return (
    <div className="min-h-screen flex flex-col bg-neutral-50">
      ...
      <main className="flex-grow">
        ...
        {/* Notion Setup CTA Section */}
        <section className="py-12 bg-primary-light/10">
          <div className="container mx-auto px-4 text-center">
            <h2 className="text-2xl md:text-3xl font-bold text-neutral-900 mb-4">
              Manage Your Airdrops with Notion
            </h2>
            <p className="text-neutral-600 max-w-2xl mx-auto mb-8">
              Configure your Notion integration to manage and display airdrops directly from your Notion database
            </p>
            <Button asChild size="lg">
              <Link href="/notion-setup" className="inline-flex">
                Setup Notion Integration
